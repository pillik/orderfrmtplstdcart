        ...
        <div class="col-md-9 pull-md-right">
            ...
            <div class="products" id="products">
				...
				{* start--product with image--*}
					{if $productinfo.{$product.pid} neq ''}
                                        	<span class="productwithimage">
                                            		<img class="productimage" src="{$WEB_ROOT}/modules/addons/ProductWithImage/uploads/{$productinfo.{$product.pid}}" height="100px" width="100px">    
                                        	</span>
                                	{/if}
