{if $producttotals}
    ...
    <div class="clearfix">
        ...
        {if $dc_product_price}<span style="text-decoration: line-through; color:red;">{$dc_product_price}</span> {$dc_product_discount_price} {else}{$producttotals.pricing.baseprice}{/if} </span>
    </div>
    ...
    {foreach $producttotals.addons as $addon}
        <div class="clearfix">
            ...
            {if $dc_addon_prices[$addon.name] && $dc_addon_prices[$addon.name] != $addon.recurring}<span style="text-decoration: line-through; color:red;">{$dc_addon_prices[$addon.name]}</span>{/if} {$addon.recurring}</span>
        </div>
    {/foreach}
        ...
        <div class="summary-totals">
            {if $producttotals.pricing.setup}
                <div class="clearfix">
                    ...
                    {if $dc_product_setup_price}<span style="text-decoration: line-through; color:red;">{$dc_product_setup_price}</span> {$dc_product_setup_discount_price} {else}{$producttotals.pricing.setup}{/if}
</span>
                </div>
            {/if}
...
{elseif $renewals}
    ...
    <div class="total-due-today">
        ...
        {discountCenterComputeTotal($producttotals.pricing.totaltoday, $dc_total_discount_price)}</span>
